...
fruit(); //op: first console.log is undefined. Reason=> JS Hoisting allows to console the name before declaring it.
...
fruit(); //op: "5" always returns as string if we declare any scope
////////////////////////////////////////////////////////////
...
console.log(-true); //op - will concatitate with true value 1
...
let c=10;
let d=c++;
console.log(c,d); //op 11 10 the increment operator(++x) increments and returns the value after incrementing.
////////////////////////////////////////////////////////////////////////////////////
...
if(typeof num==='number') return    //here we are returning anything here so it will be undefined
		return num*2
})
